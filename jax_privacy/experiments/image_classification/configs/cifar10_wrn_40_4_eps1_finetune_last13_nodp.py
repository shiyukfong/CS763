...
"""Fine-tuning a WRN-40-4 on CIFAR-10 with the last 3 residual units trainable (6 conv layers)."""
...
def get_config() -> ml_collections.ConfigDict:
    ...
    config = config_base.ExperimentConfig(
        ...
        optimizer=optimizer_config.sgd_config(
            lr=optimizer_config.constant_lr_config(1/200.0),
        ),
        ...
        training=experiment_config.TrainingConfig(
            ...
            weight_decay=0.0,
            train_only_layer=wrn40_layerwise_filters.make_train_last_wrn40_layers_filter(13),
