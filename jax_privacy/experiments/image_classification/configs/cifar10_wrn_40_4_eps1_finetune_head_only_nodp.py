...
"""Fine-tuning a WRN-40-4 on CIFAR-10 with only the classifier head trainable."""
...
def get_config() -> ml_collections.ConfigDict:
    ...
    config = config_base.ExperimentConfig(
        ...
        optimizer=optimizer_config.sgd_config(
            lr=optimizer_config.constant_lr_config(10.0/5.0),
        ),
        ...
        training=experiment_config.TrainingConfig(
            ...
            weight_decay=0.0,
            train_only_layer='wide_res_net/Softmax',
