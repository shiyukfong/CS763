...
class ExperimentConfig:
  ...
  Attributes:
    ...
    data_nc: Optional data configuration for NC evaluation.
    nc_evaluation: Optional NC evaluation configuration.
  ...
  data_nc: data.DataLoader | None = None
  nc_evaluation: experiment_config_py.NCEvaluationConfig | None = None
  random_seed: int = 0
